...
import { certificationsData } from '@/common/lib/data';
          ...
          {certificationsData.map((cert, index) => (
            ...
            >
              ...
              >
                ...
                <h3 className="font-mono text-[11px] md:text-xs text-gray-300 group-hover:text-electricCyan mt-auto text-center">
                  {cert.title}
                </h3>
              </Link>
            </motion.li>
